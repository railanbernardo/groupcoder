...
class Seo {
     ...
     * como categoria, noticia, etc. Basta usar um extract para obter as variáveis da tabela!
     * 
    ...
    private function getSeo() {
        ...
        switch ($this->File):
            ...
            //SEO:: INDEX
            case 'index':
                $this->Data = [SITENAME . ' - Online e Gratuito!', SITEDESC, HOME, INCLUDE_PATH . '/images/site.png'];
                break;
